...
const UpdateProductForm = () => {
    ...
    const { Project, Token, data, GetDetailProjectData, SetTostMsg, EditProduct, Isloading, setIsloading } = useContext(StoreContext);
    ...
    useEffect(() => {
        if (EditProduct) {
            ...
            setFormData({
                ...
                status: deepCopyEditProduct.status !== undefined ?  deepCopyEditProduct.status : true ,
