...
export default function ParentProject() {
  ...
  // Pagination logic
  const totalPages = Math.ceil(Projectparent.length / rowsPerPage);
  const startIndex = (currentPage - 1) * rowsPerPage;
  const currentData = Projectparent.slice(startIndex, startIndex + rowsPerPage);
    ...
    <Card>
        ...
        >
            ...
            <div className="flex items-center gap-4">
                ...
                <Button
                    variant="text"
                    color="light-gray"
                    onClick={handleAddProjectParent}
        ...
        <CardBody className="max-h-[415px] overflow-y-auto px-0 pt-0 pb-2">
             {currentData.length === 0 ? (
                ...
                <tbody>
                    {currentData.map((parentproject, index) => (
                       
                        <tr key={index}>
                            {/* Image */}
                             <td className="px-5 py-2 border-b border-blue-gray-50">
                             <Avatar
                             src={parentproject.img ? `${data.url}/Images/parent/${parentproject.img}` : "/img/noimg.png"}
                            ...
                            <td className=" px-5 border-b border-blue-gray-50  min-h-[100px]">
                                ...
                                <Typography  className=" text-xs font-normal text-blue-gray-500">
                                    {parentproject.status? "Active" : "Inactive"}
                                </Typography>
                            ...
                            <td className="px-5 border-b border-blue-gray-50">
                                <div className="flex justify-center items-center gap-2">
                                    ...
                                    <MdDelete
                                        className="hover:text-blue-gray-500"
                                        style={{ fontSize: "20px", cursor: "pointer" }}
                                        onClick={() => handleDelete(parentproject)}
                                    />
                                    {/* <Alertmsg
